...
function SectionTwo({handleIsWidgetLoading}) {
  ...
  return (
    <>
      <div
        className="hidden md:grid font-satoshiMedium grid-cols-12 py-[70px] md:py-[160px] xl:pt-[100px] xl:pb-[250px] md:gap-8 overflow-hidden bg-[#fff] md:relative md:z-10 px-1 md:px-0">
