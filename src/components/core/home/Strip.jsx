        ...
        <div className="bg-[url('/images/abstract.jpg')] bg-cover md:text-center col-start-2 col-span-10 md:w-[80%] mx-auto bg-black p-10 md:p-24 rounded-lg md:rounded-[32px] relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="ml-auto">
              <button
                className="my-3 md:text-[17px] text-gray-300 bg-black px-5 py-3 rounded-lg font-dmSans hover:border hover:border-gray-300 hover:bg-transparent hover:text-gray-300">
                Get started
              </button>
            </div>
          </div>
