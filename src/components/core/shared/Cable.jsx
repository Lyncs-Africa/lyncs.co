      ...
      <div className="my-2 flex flex-col gap-2">
        <div className="bg-slate-900 p-4 rounded-lg mt-4 grid grid-cols-2 gap-4">
          <div className="bg-white rounded-lg flex items-center">
            <img alt="Lyncs providers" src="/images/providers/gotv.png" className="rounded-lg w-[70px]" width="100%"/>
          </div>
          <div className="bg-white rounded-lg flex items-center">
            <img alt="Lyncs providers" src="/images/providers/startimes.png" className="ride-logo w-[70px]" width="100%"/>
          </div>
          <div className="col-span-2 h-[50px] bg-white overflow-hidden rounded-lg flex justify-center items-center">
            <img alt="Lyncs providers" src="/images/providers/dstv.png" className="ride-logo w-[90px]"/>
          </div>
        </div>
         </div>
    </div>
