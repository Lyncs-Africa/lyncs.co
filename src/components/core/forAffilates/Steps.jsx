...
const Steps = () => {
  ...
  return (
    <div className="z-10 overflow-hidden relative w-full bg-white md:bg-right bg-cover font-satoshiMedium">
      <div className="container mx-auto md:grid grid-cols-12 pt-[100px] overflow-hidden md:relative md:z-10">
        <div className="px-4 md:px-0 col-span-5 text-left col-start-2 z-50 relative flex flex-col justify-center">
          <motion.h2
          ...
          <div className="accordion pb-16">
            ...
            <motion.div
              ...
              <div className="ml-5">
                ...
                <div className="accordion-content">
                  <div className="content text-slate-500 text-[13px]">
                    After creating an account, go to the dashboard and in the settings tab, copy your shop link to your
                    clipboard
                  </div>
                </div>
              </div>
